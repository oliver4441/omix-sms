// Lightweight inline SVG icon component - replaces lucide-react
// 92 icons as pure SVG, zero dependencies

import React from "react";

export type IconName =
  | "Activity" | "AlertCircle" | "AlertTriangle" | "ArrowLeft" | "ArrowRight"
  | "ArrowUp" | "ArrowUpDown" | "ArrowUpRight" | "Award" | "Ban" | "Banknote"
  | "BarChart3" | "Beaker" | "Bell" | "BookMarked" | "BookOpen" | "Bot"
  | "Briefcase" | "Building2" | "Calendar" | "CalendarDays" | "Check" | "CheckCheck"
  | "CheckCircle" | "CheckCircle2" | "ChevronDown" | "ChevronLeft" | "ChevronRight"
  | "Chrome" | "ClipboardCheck" | "ClipboardList" | "Clock" | "CreditCard" | "DollarSign"
  | "Download" | "Edit" | "Eye" | "EyeOff" | "FileSpreadsheet" | "FileText" | "Filter"
  | "FlaskConical" | "FlaskRound" | "Globe" | "GraduationCap" | "HardDrive" | "HelpCircle"
  | "Inbox" | "Info" | "LayoutDashboard" | "Library" | "Lightbulb" | "Loader2" | "Lock"
  | "LogIn" | "LogOut" | "Mail" | "MapPin" | "Megaphone" | "Menu" | "MessageSquare"
  | "Monitor" | "MonitorSmartphone" | "Phone" | "PiggyBank" | "Plus" | "Power"
  | "PowerOff" | "Receipt" | "RefreshCcw" | "RefreshCw" | "Save" | "School" | "Search"
  | "Send" | "Settings" | "Shield" | "ShieldAlert" | "ShieldCheck" | "Smartphone"
  | "Sparkles" | "Thermometer" | "ThumbsUp" | "TrendingUp" | "User" | "UserCheck"
  | "Users" | "Wifi" | "Wrench" | "X" | "XCircle" | "Zap";
...
const PATHS: Record<IconName, string> = {
  ...
  ArrowUpDown: '<line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/><polyline points="5 12 12 5 19 12"/>',
  ArrowUpRight: '<line x1="7" y1="7" x2="17" y2="17"/><polyline points="17 7 17 17 7 17"/>',
  ...
  BookMarked: '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><polyline points="10 12 14 12"/>',
  ...
  CalendarDays: '<rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/>',
  ...
  FileSpreadsheet: '<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h2"/><path d="M14 13h2"/><path d="M8 17h2"/><path d="M14 17h2"/>',
  ...
  FlaskRound: '<path d="M10 2v7.31"/><path d="M14 9.3V1.98"/><path d="M8.5 2h7"/><path d="M14 9.3a6.5 6.5 0 0 1-4 5.63V22h4v-7.07a6.5 6.5 0 0 0 4-8.43"/><path d="M7 14.57a6.5 6.5 0 0 1-4-5.63"/>',
  ...
  Lightbulb: '<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-1.1 1.5-2.9 1.5-4.5A6 6 0 0 0 6 7c0 1.6.5 3.4 1.5 4.5.8.8 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/>',
  ...
  MonitorSmartphone: '<rect width="14" height="8" x="5" y="2" rx="2"/><rect width="6" height="12" x="15" y="10" rx="1"/><path d="M17 14h.01"/><path d="M3 10h18"/>',
  ...
  RefreshCcw: '<path d="M2 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L22 12"/><path d="M22 12a9 9 0 0 1-9-9 9.75 9.75 0 0 1 6.74 2.74L8 12"/><path d="M14 21v-3"/><path d="M10 3v3"/>',
  RefreshCw: '<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L22 8"/><path d="M22 8v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/>',
  Save: '<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/>',
  School: '<path d="m4 6 8-4 8 4"/><path d="m18 10 4 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-8l4-2"/><path d="M14 22v-4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v4"/><path d="M18 5v17"/><path d="M6 5v17"/><line x1="12" y1="7" x2="12" y2="7.01"/>',
...
export function Icon({ name, size = 24, className, ...props }: IconProps) {
  return (
    <svg
      ...
      className={className}
      {...props}
      dangerouslySetInnerHTML={{ __html: PATHS[name as IconName] }}
    />
  );
}
