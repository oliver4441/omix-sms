...
export default function ComputerLabSettingsPage() {
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      >
        ...
        <p className="text-gray-400 text-sm mt-1">
          Manage your computer lab account settings
        </p>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-4 pb-5 border-b border-border mb-5">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">Lab Attendant Profile</h2>
            <p className="text-sm text-gray-400">Computer Lab Department</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="email"
                value="computerlab@omixsystems.com"
                disabled
