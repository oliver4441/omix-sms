    ...
    <div className="space-y-6 max-w-2xl">
      ...
      >
        ...
        <p className="text-gray-400 text-sm mt-1">
          Manage your board of management account settings
        </p>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-4 pb-5 border-b border-border mb-5">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">Board Secretary Profile</h2>
            <p className="text-sm text-gray-400">Board of Management</p>
          </div>
        </div>
