    ...
    <div className="space-y-6 max-w-2xl">
      ...
      >
        ...
        <p className="text-gray-400 text-sm mt-1">
          Manage your bursar account settings
        </p>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-4 pb-5 border-b border-border mb-5">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">Bursar Profile</h2>
            <p className="text-sm text-gray-400">Bursar Department</p>
          </div>
        </div>
      ...
      >
        ...
        >
          <FormField
            ...
            required
            error={
              form.currentPassword.length === 0 && error
